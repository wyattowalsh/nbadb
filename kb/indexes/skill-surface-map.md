...
|---------------|--------------------------|----------------|
| `nba-data-analytics` | `chat/pyproject.toml`, `chat/chainlit.md`, `src/nbadb/agent/`, `src/nbadb/transform/views/`, `src/nbadb/transform/derived/` | The chat app depends on analytics tables and query helpers from the main repo |
