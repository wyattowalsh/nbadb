...
class _TeamOnOffOverallSchema(BaseSchema):
    """Pinned 57-column TeamPlayerOnOff* overall result-set contract."""
...
class StagingTeamDashboardOnOffSchema(_TeamOnOffOverallSchema):
    """Exact TeamPlayerOnOffDetails overall packet plus request scope."""
...
class StagingOnOffSchema(StagingTeamDashboardOnOffSchema):
    """Exact TeamPlayerOnOffSummary overall packet plus request scope."""
