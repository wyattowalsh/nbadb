...
class StagingTeamInfoCommonSchema(BaseSchema):
    ...
    w: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "TeamInfoCommon.TeamInfoCommon.W"
            ),
            "description": "Wins",
        },
    )
    l: int | None = pa.Field(  # noqa: E741
        ...
        metadata={
            "source": (
                "TeamInfoCommon.TeamInfoCommon.L"
            ),
            "description": "Losses",
        },
    )
    pct: float | None = pa.Field(
        ...
        metadata={
            "source": (
                "TeamInfoCommon.TeamInfoCommon.PCT"
            ),
