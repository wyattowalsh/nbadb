...
class FactTrackingDefenseSchema(BaseSchema):
    ...
    defense_category: str = pa.Field(
        metadata={
            ...
            "description": (
                "Defense category (Overall, 3pt, etc.)"
            ),
        },
    )
    ...
    d_fg_pct: float | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueDashPtDefend"
                ".LeagueDashPtDefend.D_FG_PCT"
            ),
            "description": (
                "Defended FG percentage"
            ),
        },
    )
    ...
    pct_plusminus: float | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "FG pct differential (defended vs normal)"
            ),
        },
    )
