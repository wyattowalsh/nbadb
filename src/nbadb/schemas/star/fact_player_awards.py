...
class FactPlayerAwardsSchema(BaseSchema):
    ...
    conference: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayerAwards"
                ".PlayerAwards.CONFERENCE"
            ),
            "description": (
                "Conference for award"
            ),
        },
    )
