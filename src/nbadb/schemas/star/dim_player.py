...
class DimPlayerSchema(BaseSchema):
    ...
    player_id: int = pa.Field(
        ...
        metadata={
            "source": (
                "CommonPlayerInfo"
                ".CommonPlayerInfo.PERSON_ID"
            ),
            "description": (
                "Natural key — NBA player identifier"
            ),
        },
    )
    ...
    is_current: bool = pa.Field(
        metadata={
            ...
            "description": (
                "Whether this is the current record"
            ),
        },
    )
