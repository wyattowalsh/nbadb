...
class FactMatchupSchema(BaseSchema):
    ...
    player_pts: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "BoxScoreMatchupsV3"
                ".PlayerMatchups.PLAYER_PTS"
            ),
            "description": (
                "Points scored by offensive player"
            ),
        },
    )
    team_pts: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "BoxScoreMatchupsV3"
                ".PlayerMatchups.TEAM_PTS"
            ),
            "description": (
                "Team points during matchup"
            ),
        },
    )
    matchup_ast: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "BoxScoreMatchupsV3"
                ".PlayerMatchups.MATCHUP_AST"
            ),
            "description": (
                "Assists during matchup"
            ),
        },
    )
    matchup_tov: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "BoxScoreMatchupsV3"
                ".PlayerMatchups.MATCHUP_TOV"
            ),
            "description": (
                "Turnovers during matchup"
            ),
        },
    )
    matchup_blk: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "BoxScoreMatchupsV3"
                ".PlayerMatchups.MATCHUP_BLK"
            ),
            "description": (
                "Blocks during matchup"
            ),
        },
    )
    matchup_fgm: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "BoxScoreMatchupsV3"
                ".PlayerMatchups.MATCHUP_FGM"
            ),
            "description": (
                "Field goals made during matchup"
            ),
        },
    )
