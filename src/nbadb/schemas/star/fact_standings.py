...
class FactStandingsSchema(BaseSchema):
    ...
    clinch_indicator: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3"
                ".Standings.ClinchedPostSeason"
            ),
            "description": (
                "Clinch indicator (e.g. p, x, z)"
            ),
        },
    )
