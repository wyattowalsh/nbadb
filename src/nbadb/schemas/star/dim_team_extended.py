...
class DimTeamExtendedSchema(BaseSchema):
    """Extended team dimension joining TeamDetails, TeamInfoCommon, and TeamYears."""

    # From stg_team_details
    ...
    # From stg_team_info_common (EXCLUDE team_id)
