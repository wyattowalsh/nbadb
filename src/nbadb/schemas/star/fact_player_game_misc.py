...
class FactPlayerGameMiscSchema(BaseSchema):
    ...
    opp_second_chance_pts: int | None = (
        pa.Field(
            nullable=True, ge=0,
            metadata={
                "source": (
    ...
    pct_fga_2pt: float | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Percentage of FGA that are 2pt"
            ),
        },
    )
    pct_fga_3pt: float | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Percentage of FGA that are 3pt"
            ),
        },
    )
    ...
    pct_pts_fb: float | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Pct of points from fast breaks"
            ),
        },
    )
    pct_pts_ft: float | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Pct of points from free throws"
            ),
        },
    )
    ...
    pct_ast_2pm: float | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Pct of 2pt made that are assisted"
            ),
        },
    )
    ...
    pct_ast_3pm: float | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Pct of 3pt made that are assisted"
            ),
        },
    )
