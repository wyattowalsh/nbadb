...
class FactLiveScoreBoardSchema(_LiveSnapshotMetadataMixin):
...
class FactLiveOddsSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})


class FactLivePlayByPlaySchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
...
class FactLiveBoxScoreGameSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    game_status: int | None = pa.Field(
        nullable=True,
        metadata={"description": "Live game status code"},
...
class FactLiveBoxScoreArenaSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    arena_name: str | None = pa.Field(nullable=True, metadata={"description": "Arena name"})


class BridgeLiveBoxScoreOfficialSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    person_id: int | None = pa.Field(nullable=True, metadata={"description": "Official person id"})


class FactLiveBoxScoreTeamSchema(_LiveSnapshotMetadataMixin):
    team_side: str = pa.Field(
        isin=["home", "away"], metadata={"description": "Home or away packet"}
    )
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    team_id: int | None = pa.Field(nullable=True, metadata={"description": "Team id"})
...
class FactLiveBoxScorePlayerSchema(_LiveSnapshotMetadataMixin):
    team_side: str = pa.Field(
        isin=["home", "away"], metadata={"description": "Home or away packet"}
    )
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
...
derived_output_schema()(FactLiveScoreBoardSchema)
derived_output_schema()(FactLiveOddsSchema)
derived_output_schema()(FactLivePlayByPlaySchema)
derived_output_schema()(FactLiveBoxScoreGameSchema)
derived_output_schema()(FactLiveBoxScoreArenaSchema)
derived_output_schema()(BridgeLiveBoxScoreOfficialSchema)
derived_output_schema(literal_fields={"team_side"})(FactLiveBoxScoreTeamSchema)
derived_output_schema(literal_fields={"team_side"})(FactLiveBoxScorePlayerSchema)
