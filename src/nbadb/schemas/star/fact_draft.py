...
class FactDraftSchema(BaseSchema):
    ...
    team_id: int = pa.Field(
        ...
        metadata={
            "source": (
                "DraftHistory"
                ".DraftHistory.TEAM_ID"
            ),
            "description": (
                "Drafting team identifier"
            ),
