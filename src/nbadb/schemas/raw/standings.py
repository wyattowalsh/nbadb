...
class RawLeagueStandingsV3Schema(BaseSchema):
    league_id: str = pa.Field(
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.LeagueID"
            ),
    ...
    season_id: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.SeasonID"
            ),
    ...
    team_city: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.TeamCity"
            ),
    ...
    team_name: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.TeamName"
            ),
    ...
    team_slug: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.TeamSlug"
            ),
    ...
    conference: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.Conference"
            ),
    ...
    playoff_rank: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.PlayoffRank"
            ),
    ...
    division: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.Division"
            ),
    ...
    league_rank: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.LeagueRank"
            ),
    ...
    ot_record: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "LeagueStandingsV3.Standings.OT_Record"
            ),
...
class RawPlayoffPictureSchema(BaseSchema):
    conference: str = pa.Field(
        metadata={
            "source": (
                "PlayoffPicture"
                ".EastConfPlayoffPicture.CONFERENCE"
            ),
            "description": "Conference name",
        },
    )
    ...
    high_seed_series_l: int | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Higher seed series losses"
            ),
        },
    )
    high_seed_series_remaining_g: int | None = (
        pa.Field(
            nullable=True,
            metadata={
                "source": (
                ...
                "description": (
                    "Remaining games in series"
                ),
            },
        )
    )
    high_seed_series_remaining_home_g: int | None = (
        pa.Field(
            nullable=True,
            metadata={
                "source": (
                    "PlayoffPicture"
                    ".EastConfPlayoffPicture"
                    ".HIGH_SEED_SERIES_REMAINING"
                    "_HOME_G"
                ),
                "description": (
                    "Remaining home games in series"
                ),
            },
        )
    )
    high_seed_series_remaining_away_g: int | None = (
        pa.Field(
            nullable=True,
            metadata={
                "source": (
                ...
                "description": (
                    "Remaining away games in series"
                ),
            },
        )
    )
