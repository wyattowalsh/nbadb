...
class RawCommonTeamRosterCoachesSchema(BaseSchema):
    team_id: int = pa.Field(
        ...
        metadata={
            "source": (
                "CommonTeamRoster.Coaches.TEAM_ID"
            ),
            "description": "Unique team identifier",
        },
    )
    season: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonTeamRoster.Coaches.SEASON"
            ),
            "description": "Season string",
        },
    )
    coach_id: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonTeamRoster.Coaches.COACH_ID"
            ),
            "description": (
    ...
    is_assistant: int | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Flag indicating assistant coach"
            ),
        },
    )
    ...
    school: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonTeamRoster.Coaches.SCHOOL"
            ),
            "description": (
                "School or college attended"
            ),
...
class RawFranchiseHistorySchema(BaseSchema):
    ...
    start_year: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "FranchiseHistory"
                ".FranchiseHistory.START_YEAR"
            ),
            "description": (
                "First year of franchise era"
            ),
        },
    )
    end_year: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "FranchiseHistory"
                ".FranchiseHistory.END_YEAR"
            ),
            "description": (
                "Last year of franchise era"
            ),
        },
    )
    years: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "FranchiseHistory"
                ".FranchiseHistory.YEARS"
            ),
            "description": (
                "Total years in franchise era"
            ),
        },
    )
    ...
    league_titles: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "FranchiseHistory"
                ".FranchiseHistory.LEAGUE_TITLES"
            ),
            "description": (
