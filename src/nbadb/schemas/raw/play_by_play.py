...
class RawPlayByPlayV3Schema(BaseSchema):
    ...
    action_number: int = pa.Field(
        metadata={
            "source": (
                "PlayByPlayV3"
                ".PlayByPlay.ACTION_NUMBER"
            ),
            "description": (
                "Sequential action number within game"
            ),
        },
    )
    ...
    team_tricode: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV3"
                ".PlayByPlay.TEAM_TRICODE"
            ),
            "description": (
                "Three-letter team abbreviation code"
            ),
        },
    )
    ...
    player_name_i: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV3"
                ".PlayByPlay.PLAYER_NAME_I"
            ),
            "description": (
                "Player name in initial format"
            ),
        },
    )
    ...
    shot_result: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV3"
                ".PlayByPlay.SHOT_RESULT"
            ),
            "description": (
                "Result of shot attempt"
            ),
        },
    )
    is_field_goal: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV3"
                ".PlayByPlay.IS_FIELD_GOAL"
            ),
            "description": (
                "Flag indicating if action is a "
                "field goal attempt"
            ),
        },
    )
    ...
    points_total: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV3"
                ".PlayByPlay.POINTS_TOTAL"
            ),
            "description": (
                "Total points scored on the play"
            ),
        },
    )
...
class RawPlayByPlayV2Schema(BaseSchema):
    game_id: str = pa.Field(
        metadata={
            "source": (
                "PlayByPlayV2"
    ...
    eventmsgactiontype: int = pa.Field(
        metadata={
            ...
            "description": (
                "Event message action type code"
            ),
        },
    )
    period: int = pa.Field(
    ...
    homedescription: str | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Play description for home team"
            ),
        },
    )
    ...
    visitordescription: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV2"
                ".PlayByPlay.VISITORDESCRIPTION"
            ),
            "description": (
                "Play description for visitor team"
            ),
        },
    )
    ...
    person1type: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV2"
                ".PlayByPlay.PERSON1TYPE"
            ),
            "description": (
                "Person 1 type identifier"
            ),
        },
    )
    ...
    player1_team_nickname: str | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Player 1 team nickname"
            ),
        },
    )
    player1_team_abbreviation: str | None = (
        pa.Field(
            nullable=True,
            metadata={
                "source": (
    ...
    person2type: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV2"
                ".PlayByPlay.PERSON2TYPE"
            ),
            "description": (
                "Person 2 type identifier"
            ),
        },
    )
    ...
    player2_team_nickname: str | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Player 2 team nickname"
            ),
        },
    )
    player2_team_abbreviation: str | None = (
        pa.Field(
            nullable=True,
            metadata={
                "source": (
    ...
    person3type: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayByPlayV2"
                ".PlayByPlay.PERSON3TYPE"
            ),
            "description": (
                "Person 3 type identifier"
            ),
        },
    )
    ...
    player3_team_nickname: str | None = pa.Field(
        ...
        metadata={
            ...
            "description": (
                "Player 3 team nickname"
            ),
        },
    )
    player3_team_abbreviation: str | None = (
        pa.Field(
            nullable=True,
            metadata={
                "source": (
