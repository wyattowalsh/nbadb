...
class RawLiveScoreBoardSchema(_LiveSnapshotMetadataMixin):
...
class RawLiveOddsSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})


class RawLivePlayByPlaySchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
...
class RawLiveBoxScoreGameDetailsSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    game_status: int | None = pa.Field(
        nullable=True,
        metadata={"description": "Live game status code"},
...
class RawLiveBoxScoreArenaSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    arena_name: str | None = pa.Field(nullable=True, metadata={"description": "Arena name"})


class RawLiveBoxScoreOfficialsSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    person_id: int | None = pa.Field(nullable=True, metadata={"description": "Official person id"})


class RawLiveBoxScoreTeamStatsSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
    team_id: int | None = pa.Field(nullable=True, metadata={"description": "Team id"})
    score: int | None = pa.Field(nullable=True, metadata={"description": "Live team score"})


class RawLiveBoxScorePlayerStatsSchema(_LiveSnapshotMetadataMixin):
    game_id: str | None = pa.Field(nullable=True, metadata={"description": "Live game id"})
