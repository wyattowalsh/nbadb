...
class RawCommonAllPlayersSchema(BaseSchema):
    ...
    roster_status: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.ROSTER_STATUS"
            ),
    ...
    from_year: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.FROM_YEAR"
            ),
    ...
    to_year: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.TO_YEAR"
            ),
    ...
    playercode: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.PLAYERCODE"
            ),
    ...
    team_id: int | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.TEAM_ID"
            ),
    ...
    team_city: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.TEAM_CITY"
            ),
    ...
    team_name: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.TEAM_NAME"
            ),
    ...
    team_code: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "CommonAllPlayers.CommonAllPlayers.TEAM_CODE"
            ),
...
class RawPlayerIndexSchema(BaseSchema):
    person_id: int = pa.Field(
        gt=0,
        metadata={
            "source": "PlayerIndex.PlayerIndex.PERSON_ID",
            "description": "Unique player identifier",
        },
    )
    player_last_name: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": (
                "PlayerIndex.PlayerIndex.PLAYER_LAST_NAME"
            ),
            "description": "Player last name",
        },
    )
    player_first_name: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": (
                "PlayerIndex.PlayerIndex.PLAYER_FIRST_NAME"
            ),
    ...
    player_slug: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.PLAYER_SLUG",
    ...
    team_id: int | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.TEAM_ID",
            "description": "Team identifier",
        },
    )
    team_slug: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.TEAM_SLUG",
    ...
    is_defunct: int | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.IS_DEFUNCT",
    ...
    team_city: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.TEAM_CITY",
            "description": "Team city name",
        },
    )
    team_name: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.TEAM_NAME",
            "description": "Team name",
        },
    )
    team_abbreviation: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayerIndex.PlayerIndex.TEAM_ABBREVIATION"
            ),
            "description": "Team abbreviation code",
        },
    )
    jersey_number: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayerIndex.PlayerIndex.JERSEY_NUMBER"
            ),
    ...
    position: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.POSITION",
    ...
    height: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.HEIGHT",
    ...
    weight: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.WEIGHT",
    ...
    college: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.COLLEGE",
    ...
    country: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.COUNTRY",
    ...
    draft_year: int | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.DRAFT_YEAR",
    ...
    draft_round: int | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.DRAFT_ROUND",
    ...
    draft_number: int | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.DRAFT_NUMBER",
    ...
    roster_status: float | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayerIndex.PlayerIndex.ROSTER_STATUS"
            ),
    ...
    stats_timeframe: str | None = pa.Field(
        ...
        metadata={
            "source": (
                "PlayerIndex.PlayerIndex.STATS_TIMEFRAME"
            ),
    ...
    from_year: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.FROM_YEAR",
            "description": "First year in the league",
        },
    )
    to_year: str | None = pa.Field(
        nullable=True,
        metadata={
            "source": "PlayerIndex.PlayerIndex.TO_YEAR",
            "description": "Last year in the league",
        },
    )
