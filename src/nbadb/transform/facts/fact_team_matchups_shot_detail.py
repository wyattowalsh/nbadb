...
_TEAM_MATCHUP_SHOT_DETAIL_SPECS: tuple[ComparisonDetailSpec, ...] = (
    ComparisonDetailSpec(
...
class FactTeamMatchupsShotDetailTransformer(BaseTransformer):
    output_table: ClassVar[str] = "fact_team_matchups_shot_detail"
    depends_on: ClassVar[list[str]] = [spec.staging_key for spec in _TEAM_MATCHUP_SHOT_DETAIL_SPECS]

    def transform(self, staging: dict[str, pl.LazyFrame]) -> pl.DataFrame:
        return consolidate_detail_family(
            staging,
            specs=_TEAM_MATCHUP_SHOT_DETAIL_SPECS,
