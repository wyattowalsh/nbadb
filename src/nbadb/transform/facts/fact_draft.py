...
class FactDraftTransformer(BaseTransformer):
    ...
    def transform(self, staging: dict[str, pl.LazyFrame]) -> pl.DataFrame:
        conn = duckdb.connect()
        conn.register("stg_draft", staging["stg_draft"].collect())
        conn.register("stg_draft_combine", staging["stg_draft_combine"].collect())
