...
- `content/docs/schema/{raw,staging,star}-reference.mdx`
- `content/docs/data-dictionary/{raw,staging,star}.mdx`
- `content/docs/diagrams/er-auto.mdx` — ER diagram from schema definitions
- `content/docs/lineage/lineage-auto.mdx` — Lineage from transform dependencies
- `lib/generated/{raw,staging,star}-reference.json`
- `lib/generated/{raw,staging,star}-dictionary.json`
- `lib/generated/{schema,lineage,schema-coverage,agent-catalog}.json`
- `lib/site-metrics.generated.ts`
- `table-profile.generated.json` when `data/nba.duckdb` exists
