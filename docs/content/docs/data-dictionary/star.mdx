...
| `season_year` | `String` | No | Season year (e.g. 2024-25) (FK → dim_season.season_year) | `derived.season_year` |
| `city` | `String` | Yes | Team city for season | `FranchiseHistory.FranchiseHistory.TEAM_CITY` |
| `nickname` | `String` | Yes | Team nickname for season | `FranchiseHistory.FranchiseHistory.TEAM_NAME` |
| `abbreviation` | `String` | Yes | Team abbreviation for season | `TeamInfoCommon.TeamInfoCommon.TEAM_ABBREVIATION` |
...
| `in_period` | `Int64` | Yes | Period when player checked in | `GameRotation.HomeTeam.IN_PERIOD` |
| `out_period` | `Int64` | Yes | Period when player checked out | `GameRotation.HomeTeam.OUT_PERIOD` |
