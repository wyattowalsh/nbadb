...
**Lands in:**
- `SynergyPlayTypes` &rarr; `stg_synergy` &rarr; `fact_synergy`
- `LeagueSeasonMatchups` &rarr; `stg_season_matchups` &rarr; `fact_season_matchups`
- `LeagueDashLineups` &rarr; `stg_lineup` &rarr; `fact_lineup_stats`, `bridge_lineup_player`
...
**Lands in:**
- `AllTimeLeadersGrids` &rarr; `stg_all_time_leaders_*` (19 staging tables, one per stat category) &rarr; `agg_all_time_leaders`
