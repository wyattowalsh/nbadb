...
<div className="grid gap-4 md:grid-cols-3">
  <ScoutCard
    title="Drop from the league view into a club file"
    label="Next stop"
  >
    Open <a href="/docs/endpoints/team-stats">Team Stats</a> when standings or
    lineup questions need roster sheets, franchise detail, or year-by-year team
    context.
  </ScoutCard>
  <ScoutCard title="Turn a leaderboard into a player dossier" label="Next stop">
    Continue to <a href="/docs/endpoints/player-stats">Player Stats</a> when a
    league ranking needs player bio, awards, career history, or dashboard detail
    behind the name.
  </ScoutCard>
  <ScoutCard title="Drill into one matchup" label="Next stop">
    Move to <a href="/docs/endpoints/box-scores">Box Scores</a> when a season
    trend or matchup question needs the single-game package keyed by{" "}
    <code>game_id</code>.
  </ScoutCard>
</div>
