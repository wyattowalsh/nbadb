...
<div className="grid gap-4 md:grid-cols-3">
  <ScoutCard title="Drill into the people on the roster" label="Next stop">
    Move to <a href="/docs/endpoints/player-stats">Player Stats</a> when the team file
    needs player bios, career arcs, awards, and individual dashboards behind the roster sheet.
  </ScoutCard>
  <ScoutCard title="Zoom out to season-wide competition" label="Next stop">
    Use <a href="/docs/endpoints/league-stats">League Stats</a> to place one franchise inside
    the standings, leaderboards, lineups, and matchup environment for a given season.
  </ScoutCard>
  <ScoutCard title="Connect franchise context to incoming talent" label="Next stop">
    Open <a href="/docs/endpoints/draft">Draft</a> when the next question is about pick history,
    class order, or combine packets tied to a team-building timeline.
  </ScoutCard>
</div>
