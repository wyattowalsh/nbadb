...
<div className="grid gap-4 md:grid-cols-3">
  <ScoutCard title="Place the player inside a club file" label="Next stop">
    Continue to <a href="/docs/endpoints/team-stats">Team Stats</a> when a
    player dossier needs roster context, front-office detail, or franchise
    history around the same people and seasons.
  </ScoutCard>
  <ScoutCard title="Trace the pre-NBA background" label="Next stop">
    Open <a href="/docs/endpoints/draft">Draft</a> to connect current player
    records back to class order, combine testing, and prospect-era measurements.
  </ScoutCard>
  <ScoutCard title="Benchmark against the whole league" label="Next stop">
    Jump to <a href="/docs/endpoints/league-stats">League Stats</a> when one
    player's dashboard needs leaderboards, lineup context, or season-wide
    comparison sets.
  </ScoutCard>
</div>
