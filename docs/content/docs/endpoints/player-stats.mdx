...
**Lands in:**
- `CommonAllPlayers` &rarr; `stg_all_players` &rarr; `dim_all_players`
- `PlayerIndex` &rarr; `stg_player_index` (model-excluded; `dim_player` is modeled from `CommonPlayerInfo`)
...
**Lands in:**
- `CommonPlayerInfo` &rarr; `stg_player_info`, `stg_player_headline_stats`, `stg_player_available_seasons` &rarr; `dim_player`, `fact_player_headline_stats`, `fact_player_available_seasons`, `bridge_player_team_season`
- `PlayerCareerStats` &rarr; `stg_player_career` &rarr; `fact_player_career`, `fact_player_profile`
- `PlayerAwards` &rarr; `stg_player_awards` &rarr; `fact_player_awards`
...
**Lands in:**
- `PlayerDashboardByYearOverYear` &rarr; `stg_player_dashboard_yoy` &rarr; `fact_player_dashboard_yoy_overall`, `fact_player_yoy_detail`
- `PlayerGameStreakFinder` &rarr; `stg_streak_finder` &rarr; `fact_streak_finder`
