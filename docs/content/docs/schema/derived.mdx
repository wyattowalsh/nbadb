...
<div className="grid gap-4 md:grid-cols-2">
  <ScoutCard title="Choose the right rollup cluster" label="Jump to section">
    Start with <a href="#choose-the-rollup">Choose the rollup</a> when you need the fastest way to map a player, team, lineup, or league question to the right aggregate family.
  </ScoutCard>
  <ScoutCard title="Player aggregation surfaces" label="Jump to section">
    Go to <a href="#player-aggregation-bench-unit">Player aggregation bench unit</a> for career, season, per-minute, rolling-form, clutch, and on/off summaries.
  </ScoutCard>
  <ScoutCard title="Team and league summaries" label="Jump to section">
    Jump to <a href="#team-and-lineup-aggregation-bench-unit">Team and lineup aggregation bench unit</a> or <a href="#league-context-aggregations">League-context aggregations</a> when the question is bigger than one player.
  </ScoutCard>
  <ScoutCard title="Know when to drop down" label="Generated boundary">
    If the rollup hides too much, fall back to <a href="/docs/schema/facts">Facts &amp; Bridges</a>. If you need exact schema-backed columns, finish on <a href="/docs/schema/star-reference">Star Reference</a>.
  </ScoutCard>
</div>
...
<Callout>
If you still find yourself joining three or four tables after landing on an `agg_` output, check <a href="/docs/schema/analytics-views">Analytics Views</a>. If you need a column that only exists at atomic grain, drop back to the relevant <a href="/docs/schema/facts">Facts</a> family.
</Callout>
