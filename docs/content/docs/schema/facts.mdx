---
title: Facts & Bridges
description: Scouting report for the 102 fact outputs and 2 bridge tables in the nbadb warehouse
---
...
<StatGrid columns={3}>
  <StatPill
    label="Fact outputs"
    value="102"
    note="game, season, event, dashboard, and specialty measurements"
  />
  <StatPill
    label="Bridge tables"
    value="2"
    note="clean many-to-many connectors for crews and play participants"
  />
  <StatPill
    label="Best habit"
    value="Start narrow"
