...
<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
  ...
  <ScoutCard title="Bridges absorb many-to-many edges" label="Join rule">
    Let the five bridge tables (`bridge_game_official`, `bridge_play_player`,
    `bridge_game_team`, `bridge_lineup_player`, `bridge_player_team_season`)
    handle expansion instead of repeating columns or reverse-engineering slot
    logic from a fact table.
  </ScoutCard>
