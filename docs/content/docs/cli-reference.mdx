...
| `nbadb upload`                      | Publish the data directory to Kaggle                                | Ensures `dataset-metadata.json` exists first; `--verify-remote` downloads the published bundle for readback   |
...
| `nbadb upload`                      | Upload the dataset directory to Kaggle                                                 | —               | `--data-dir/-d`, `--message/-m` (default: `"Automated update"`), `--verify-remote`                |
