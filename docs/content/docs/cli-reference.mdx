...
| `nbadb upload`                      | Upload the dataset directory to Kaggle                                                 | —               | `--data-dir/-d`, `--message/-m` (default: `"Automated update"`), `--verify-remote`, `--remote-timeout` (default: `3600`), `--remote-poll-interval` (default: `15`) |
