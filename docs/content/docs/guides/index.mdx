...
<StatGrid columns={4}>
  <StatPill
    label="Guides"
    value="Hands-on"
    note="public developer and usage workflows"
  />
  <StatPill
    label="Tracks"
    value="4"
...
Text fallback: start on an opening-drill page, then branch into one of three lanes. Skill work is for reusable analysis patterns, game-day ops is for recurring runs and delivery, and film room and recovery is for troubleshooting once a run misses.
...
<div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
  ...
  <ScoutCard title="Film room & recovery" label="Explain or recover the miss">
    Use{" "}
    <a href="/docs/guides/troubleshooting-playbook">Troubleshooting Playbook</a>{" "}
    when the artifact is broken and you need the narrowest recovery loop before
    widening back out to schema, lineage, or architecture docs.
  </ScoutCard>
</div>
