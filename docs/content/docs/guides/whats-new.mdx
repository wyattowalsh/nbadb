...
<Callout>
This page tracks notable changes. For the full commit history, see the [GitHub repository](https://github.com/wyattowalsh/nba-db).
</Callout>
...
- **16 new fact transforms** — cumulative stats, clutch detail, shooting splits, and more
- **4 new analytics views** — clutch performance, player matchup, shooting efficiency, team game complete
- **8 extended transforms** — dashboard detail families across splits categories
- **Full test suite** — 1846+ tests passing, ruff lint clean
...
- **49 documentation pages** — schema reference, data dictionary, diagrams, endpoints, lineage, guides
