...
<Callout type="info">
  **Rule of thumb:** Within Phase 0 and Phase 1, tracks can generally move independently.
  Once dual-write begins in Phase 2, downstream tracks must wait for upstream tracks to
  stabilize. Legacy retirement in Phase 3 always proceeds one track at a time to limit
  blast radius.
</Callout>
