---
title: Daily Updates
description: Game-day runbook for keeping nbadb current with daily, monthly, and targeted backfill refreshes.
---
...
- discovers the current season across all five declared season types: Regular Season, Playoffs, Pre Season, All Star, and PlayIn
...
**Best fit:** a wider recent-history refresh across the last 3 seasons, using
...
**Best fit:** retrying failed extractions, filling gaps for specific seasons or endpoints, or re-extracting with `--force`.
